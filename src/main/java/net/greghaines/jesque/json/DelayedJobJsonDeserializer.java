 ...
 * @author Greg Haines
 */
public class DelayedJobJsonDeserializer extends JsonDeserializer<DelayedJob> {

    private static final TypeReference<Object[]> objectArrTypeRef = 
            new TypeReference<Object[]>() {};

    @Override
    public DelayedJob deserialize(final JsonParser jp, final DeserializationContext ctxt) throws IOException,
        ...
        while (jp.getCurrentToken() != JsonToken.END_OBJECT) {
            ...
            if ("class".equals(jp.getText())) {
                ...
                jp.nextToken();
                _queue = jp.readValueAs(String.class);
        ...
        return new DelayedJob(clazz, _queue, args);
    }
}
